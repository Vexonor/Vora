...
const STATUS_OPTIONS = [
  { value: MenuStatus.AVAILABLE, label: "Tersedia",    dotClass: "bg-primary" },
  { value: MenuStatus.SOLD_OUT,  label: "Habis",       dotClass: "bg-destructive" },
  { value: MenuStatus.INACTIVE,  label: "Tidak Aktif", dotClass: "bg-foreground/40" },
]
...
export function MenuFilterDropdown({ selected, onApply }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-48 bg-white border border-foreground/10 rounded-xl shadow-lg z-50 p-3 flex flex-col gap-0.5">
